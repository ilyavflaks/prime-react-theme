...
export class Home extends Component {
  ...
  componentDidMount() {
    this.countryService
      .getCountries()
      .then((data) => this.setState({ autoValue: data }));
  ...
  onCheckboxOptionChange(e) {
    ...
    if (e.checked) checkboxValues.push(e.value);
    else checkboxValues.splice(checkboxValues.indexOf(e.value), 1);
  ...
  addMessage(severity) {
    this.msgs1.show([
      {
        severity,
        summary: this.capitalize(severity),
    ...
    return (
      <>
        ...
        <img
          ...
          className={`flag flag-${data.country.code} mr-2`}
          width="30"
        />
  ...
  representativeBodyTemplate(data) {
    return (
      <>
        ...
        />
        <span className="image-text ml-2">{data.representative.name}</span>
      </>
    );
  }
  ...
  render() {
    const containerClassName = classNames("home grid", {
      ...
      <div className={containerClassName}>
        <div className="col-12 md:col-6 p-fluid">
          <div className="card">
            ...
            <span className="p-float-label">
              <InputText
                ...
                onChange={(e) => this.setState({ floatValue: e.target.value })}
              />
            ...
            <AutoComplete
              ...
              dropdown
              multiple
              value={this.state.selectedAutoValue}
              suggestions={this.state.autoFilteredValue}
              completeMethod={this.searchCountry}
              field="name"
              onChange={(e) => this.setState({ selectedAutoValue: e.value })}
            />
            ...
            <InputNumber
              ...
              onValueChange={(e) =>
                this.setState({ inputNumberValue: e.value })
              }
              showButtons
              mode="decimal"
            ></InputNumber>
          ...
          <div className="card">
            ...
            <InputSwitch
              ...
              onChange={(e) => this.setState({ switchValue: e.value })}
            />
          </div>
        </div>
        ...
        <div className="col-12 md:col-6">
              ...
              <div className="col-12 md:col-4">
                <div className="field-radiobutton">
                  <RadioButton
                    ...
                    checked={this.state.radioValue === "Option 1"}
                  />
              ...
              <div className="col-12 md:col-4">
                <div className="field-radiobutton">
                  <RadioButton
                    ...
                    value="Option 2"
                    onChange={(e) => this.setState({ radioValue: e.value })}
                    checked={this.state.radioValue === "Option 2"}
                  />
              ...
              <div className="col-12 md:col-4">
                <div className="field-radiobutton">
                  <RadioButton
                    ...
                    value="Option 3"
                    onChange={(e) => this.setState({ radioValue: e.value })}
                    checked={this.state.radioValue === "Option 3"}
                  />
              ...
              <div className="col-12 md:col-4">
                <div className="field-checkbox">
                  <Checkbox
                    ...
                    name="option"
                    value="Option 1"
                    onChange={this.onCheckboxOptionChange}
                    checked={
                      this.state.checkboxValues.indexOf("Option 1") !== -1
                    }
                  />
              ...
              <div className="col-12 md:col-4">
                <div className="field-checkbox">
                  <Checkbox
                    ...
                    onChange={this.onCheckboxOptionChange}
                    checked={
                      this.state.checkboxValues.indexOf("Option 2") !== -1
                    }
                  />
              ...
              <div className="col-12 md:col-4">
                <div className="field-checkbox">
                  <Checkbox
                    ...
                    onChange={this.onCheckboxOptionChange}
                    checked={
                      this.state.checkboxValues.indexOf("Option 3") !== -1
                    }
                  />
          ...
          <div className="card p-fluid">
            <h5>Listbox</h5>
            <ListBox
              value={this.state.listboxValue}
              options={this.listboxValues}
              onChange={(e) => this.setState({ listboxValue: e.value })}
              optionLabel="name"
              filter
            />
            ...
            <MultiSelect
              ...
              onChange={(e) => this.setState({ multiselectValue: e.value })}
              optionLabel="name"
          ...
          <div className="card p-fluid">
            ...
            <h5>SelectButton</h5>
            <SelectButton
              value={this.state.selectButtonValue1}
              options={this.selectButtonValues1}
              onChange={(e) => this.setState({ selectButtonValue1: e.value })}
              optionLabel="name"
            />

            <h5>SelectButton - Multiple</h5>
            <SelectButton
              value={this.state.selectButtonValue2}
              options={this.selectButtonValues2}
              onChange={(e) => this.setState({ selectButtonValue2: e.value })}
              optionLabel="name"
              multiple
            />
          </div>
        ...
        <div className="col-12">
          <div className="card">
            ...
            <Button
              label="Disabled"
              disabled="disabled"
              className="mr-2 button-gray"
            />

            <h5>Severities</h5>
            <Button label="Primary" className="mr-2" />
            <Button label="Secondary" className="p-button-secondary mr-2" />
            <Button label="Success" className="p-button-success mr-2" />
            <Button label="Info" className="p-button-info mr-2" />
            <Button label="Warning" className="p-button-warning mr-2" />
            <Button label="Help" className="p-button-help mr-2" />
            <Button label="Danger" className="p-button-danger mr-2" />

            <h5>Raised Buttons</h5>
            <Button label="Primary" className="p-button-raised mr-2" />
            <Button
              label="Secondary"
            ...
            <Button
              label="Help"
              className="p-button-raised p-button-help mr-2"
            />
            <Button
              label="Danger"
            ...
            <Button
              label="Primary"
              className="p-button-raised p-button-text mr-2"
            />
            <Button
              label="Secondary"
            ...
            <Button
              label="Success"
              className="p-button-raised p-button-success p-button-text mr-2"
            />
            <Button
              label="Info"
              className="p-button-raised p-button-info p-button-text mr-2"
            />
            <Button
              label="Warning"
              className="p-button-raised p-button-warning p-button-text mr-2"
            />
            <Button
              label="Help"
              className="p-button-raised p-button-help p-button-text mr-2"
            />
            <Button
              label="Danger"
              className="p-button-raised p-button-danger p-button-text mr-2"
            />
            <Button
              label="Plain"
            ...
            <Button label="Primary" className="p-button-outlined mr-2" />
            <Button
              label="Secondary"
            ...
            <Button icon="pi pi-check" className="p-button-rounded mr-2" />
            <Button
              icon="pi pi-bookmark"
            ...
            <Button
              icon="pi pi-bookmark"
              className="p-button-rounded p-button-secondary p-button-outlined mr-2"
            />
            <Button
              icon="pi pi-search"
            ...
            <Button
              icon="pi pi-heart"
              className="p-button-rounded p-button-help p-button-outlined mr-2"
            />
            <Button
              icon="pi pi-times"
            ...
            <h5>Badges</h5>
            <Button type="button" label="Emails" badge="8" className="mr-2" />
            <Button
              type="button"
              label="Messages"
              icon="pi pi-users"
        ...
        <div className="col-12">
          <div className="card card-w-title">
            <h5>Menubar</h5>
            <Menubar
              model={this.tieredMenuItems}
              end={this.menubarEndTemplate()}
            ></Menubar>
          </div>
        </div>
        <div className="col-12 md:col-4">
        ...
        <div className="col-12 lg:col-6">
          <div className="card">
            <h5>Messages</h5>
            <Button
              onClick={() => this.addMessage("info")}
              label="Info"
              className="p-button-info mr-2"
            />
            <Button
              onClick={() => this.addMessage("success")}
              label="Success"
              className="p-button-success mr-2"
            />
            <Button
              onClick={() => this.addMessage("warn")}
              label="Warn"
              className="p-button-warning mr-2"
            />
            <Button
              onClick={() => this.addMessage("error")}
              label="Error"
        ...
        <div className="col-12 lg:col-6">
          <div className="card">
            ...
            <Button
              onClick={() => this.showToast("info")}
              label="Info"
              className="p-button-info mr-2"
            />
            <Button
              onClick={() => this.showToast("success")}
              label="Success"
              className="p-button-success mr-2"
            />
            <Button
              onClick={() => this.showToast("warn")}
              label="Warn"
              className="p-button-warning mr-2"
            />
            <Button
              onClick={() => this.showToast("error")}
              label="Error"
              className="p-button-danger"
            />
          </div>
